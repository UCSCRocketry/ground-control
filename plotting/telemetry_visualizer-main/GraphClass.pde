...
/*   =================================================================================       
    ...
    class Graph 
    {
      ...
      color   GraphColor;
      color   BackgroundColor=color(24,24,24);  
  ...
  //    int Peakcounter=0,nPeakcounter=0;
   ...
   /*  =========================================================================================
       ...
       ==========================================================================================  */
        ...
        rect(xPos+Width/2-c/2,yPos-500,c,0);                         // Heading Rectangle  
        
        fill(255);
        text(Title,xPos+Width/2,yPos-20);                            // Heading Title
        ...
        textSize(10); noFill(); stroke(255); smooth();strokeWeight(1);
          //Edges
          line(xPos-40,yPos+Height,xPos-40,yPos);                        // y-axis line 
          line(xPos-40,yPos+Height,xPos+Width+40,yPos+Height);           // x-axis line 
          
           stroke(255,0,0);
          if(yMin<0){
                    line(xPos-40,                                       // zero line 
          ...
          if(RightAxis){                                       // Right-axis line   
              stroke(255);
              line(xPos+Width-40,yPos+Height,xPos+Width+3,yPos);
           ...
           for(int x=0; x<=xDiv; x++){
            ...
            line(1.46*float(x)/xDiv*Width+xPos-40,yPos+Height,       //  x-axis Sub devisions    
                 1.46*float(x)/xDiv*Width+xPos-40,yPos+Height+5);     
            ...
            text(xAxisMS[0]+"."+xAxisMS[1].charAt(0),          // ...
                 1.46*float(x)/xDiv*Width+xPos-40,yPos+Height+15);   // x-axis Labels
          }
          ...
          for(int y=0; y<=yDiv; y++){
            line(xPos-40,float(y)/yDiv*Height+yPos,                // ...
                  xPos-40,float(y)/yDiv*Height+yPos);              // y-axis lines 
            ...
            text(yAxisMS[0]+"."+yAxisMS[1].charAt(0),             // ... 
                 xPos-45,float(yDiv-y)/yDiv*Height+yPos+3);       // y-axis Labels 
            ...
            if(RightAxis){
              ...
              line(xPos+Width-100,float(y)/yDiv*Height+yPos,             // ...
                   xPos+Width-100,float(y)/yDiv*Height+yPos);            // Right Y axis sub devisions
   ...
   /*  =========================================================================================
      ...
      void LineGraph(float[] x ,float[] y) {
         ...
         for (int i=0; i<(x.length-1); i++){
                    strokeWeight(2);stroke(GraphColor);noFill();smooth();
           line((xPos-40)+(x[i]-x[0])/(x[x.length-1]-x[0])*(Width*1.45),
                                            yPos+Height-(y[i]/(yMax-yMin)*Height)+(yMin)/(yMax-yMin)*Height,
                                            (xPos-40+(x[i+1]-x[0])/(x[x.length-1]-x[0])*(Width*1.45)),
